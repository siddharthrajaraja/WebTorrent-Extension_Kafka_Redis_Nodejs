...
exports.sendInvitationEmail = async (emailID,roomID) => {
  ...
  let info = await transporter.sendMail({
    ...
    html: `HELLO ${emailID}, please join ${process.env.APP_NAME} new Room given below!! , <a href="${process.env.ROOM_MAIL_URL}/${hashedEmailID}?email=${emailID}?roomID=${roomID}">Click To JOIN GROUP!!</a>` // html body
  });
